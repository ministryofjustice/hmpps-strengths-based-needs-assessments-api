...
class Accommodation : SectionMapping() {
  ...
  private fun q97(): Any? = PractitionerAnalysis("ACCOMMODATION", ap).notes()

  private fun q98(): Any? = PractitionerAnalysis("ACCOMMODATION", ap).riskOfSeriousHarm()

  private fun q99(): Any? = PractitionerAnalysis("ACCOMMODATION", ap).riskOfReoffending()

  private fun qStrength(): Any? = PractitionerAnalysis("ACCOMMODATION", ap).strengthsOrProtectiveFactors()
}
