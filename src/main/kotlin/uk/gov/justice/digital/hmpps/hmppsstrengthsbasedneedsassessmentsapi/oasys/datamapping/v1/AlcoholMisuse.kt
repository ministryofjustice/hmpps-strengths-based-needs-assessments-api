...
class AlcoholMisuse : SectionMapping() {
  ...
  private fun q97(): Any? = PractitionerAnalysis("ALCOHOL_USE", ap).notes()

  private fun q98(): Any? = PractitionerAnalysis("ALCOHOL_USE", ap).riskOfSeriousHarm()

  private fun q99(): Any? = PractitionerAnalysis("ALCOHOL_USE", ap).riskOfReoffending()

  private fun qStrength(): Any? = PractitionerAnalysis("ALCOHOL_USE", ap).strengthsOrProtectiveFactors()
}
