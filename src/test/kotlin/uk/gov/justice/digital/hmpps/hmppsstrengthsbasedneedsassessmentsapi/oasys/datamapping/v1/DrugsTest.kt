...
class DrugsTest : SectionMappingTest(Drugs(), "1.0") {
  ...
  fun q6() {
    test(
      ...
      Given(Field.DRUGS_INJECTED_HEROIN, Value.NO).expect("0"),
      Given(Field.DRUGS_INJECTED_METHADONE_NOT_PRESCRIBED, Value.NO).expect("0"),
      Given(Field.DRUGS_INJECTED_OTHER_OPIATES, Value.NO).expect("0"),
      Given(Field.DRUGS_INJECTED_CRACK, Value.NO).expect("0"),
      Given(Field.DRUGS_INJECTED_COCAINE, Value.NO).expect("0"),
      Given(Field.DRUGS_INJECTED_MISUSED_PRESCRIBED_DRUGS, Value.NO).expect("0"),
      Given(Field.DRUGS_INJECTED_BENZODIAZEPINES, Value.NO).expect("0"),
      Given(Field.DRUGS_INJECTED_AMPHETAMINES, Value.NO).expect("0"),
      Given(Field.DRUGS_INJECTED_STEROIDS, Value.NO).expect("0"),
      Given(Field.DRUGS_INJECTED_OTHER_DRUG, Value.NO).expect("0"),

      Given(Field.DRUGS_INJECTED_HEROIN, Value.YES).expect("2"),
      Given(Field.DRUGS_INJECTED_METHADONE_NOT_PRESCRIBED, Value.YES).expect("2"),
      Given(Field.DRUGS_INJECTED_OTHER_OPIATES, Value.YES).expect("2"),
      Given(Field.DRUGS_INJECTED_CRACK, Value.YES).expect("2"),
      Given(Field.DRUGS_INJECTED_COCAINE, Value.YES).expect("2"),
      Given(Field.DRUGS_INJECTED_MISUSED_PRESCRIBED_DRUGS, Value.YES).expect("2"),
      Given(Field.DRUGS_INJECTED_BENZODIAZEPINES, Value.YES).expect("2"),
      Given(Field.DRUGS_INJECTED_AMPHETAMINES, Value.YES).expect("2"),
      Given(Field.DRUGS_INJECTED_STEROIDS, Value.YES).expect("2"),
      ...
      Given(Field.DRUGS_INJECTED_HEROIN, Value.YES).expect("1"),
      Given(Field.DRUGS_INJECTED_METHADONE_NOT_PRESCRIBED, Value.YES).expect("1"),
      Given(Field.DRUGS_INJECTED_OTHER_OPIATES, Value.YES).expect("1"),
      Given(Field.DRUGS_INJECTED_CRACK, Value.YES).expect("1"),
      Given(Field.DRUGS_INJECTED_COCAINE, Value.YES).expect("1"),
      Given(Field.DRUGS_INJECTED_MISUSED_PRESCRIBED_DRUGS, Value.YES).expect("1"),
      Given(Field.DRUGS_INJECTED_BENZODIAZEPINES, Value.YES).expect("1"),
      Given(Field.DRUGS_INJECTED_AMPHETAMINES, Value.YES).expect("1"),
      Given(Field.DRUGS_INJECTED_STEROIDS, Value.YES).expect("1"),
      Given(Field.DRUGS_INJECTED_OTHER_DRUG, Value.YES).expect("1"),

      // past heroin and current cocaine
      Given(Field.DRUGS_INJECTED_HEROIN, Value.YES)
        .and(Field.DRUGS_INJECTED_COCAINE, Value.YES)
        .expect("2"),
    )
  }
